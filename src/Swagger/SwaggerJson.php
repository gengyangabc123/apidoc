...
class SwaggerJson
{
    ...
    public function addPath($className, $methodName, $route, $requestMethod)
    {
        ...
        $methodAnnotations = ApiAnnotation::methodMetadata($className, $methodName, $route, $requestMethod);
